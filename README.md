...
DSLR tidak dapat dipakai dari frontend Vercel karena server cloud tidak memiliki akses ke USB kamera. Jalankan mode kiosk di komputer booth, lalu buka `http://localhost:8787`:
